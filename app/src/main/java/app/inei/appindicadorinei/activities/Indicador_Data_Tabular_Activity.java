...
public class Indicador_Data_Tabular_Activity extends AppCompatActivity implements Lista_M12_Fragment.OnFragmentInteractionListener, Contenido_M12_Fragment.OnFragmentInteractionListener, IComunicaFragments {
    int id;
    int id_indicador;
    String title;
    int nro_grafico;
    LinearLayout lyTabular;
    TextView txt_titulo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_tabular);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.lista_graficos_tabular);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.id_item_descarga_imagen) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                if (ActivityCompat.checkSelfPermission(Indicador_Data_Tabular_Activity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        == PackageManager.PERMISSION_GRANTED){
                    descargarGrafico(title);
                }
                else
                { ActivityCompat.requestPermissions(Indicador_Data_Tabular_Activity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);}
            }
            else
            {
                descargarGrafico(title);
    ...
    {   ArrayList<String> datos = new ArrayList<>();
        ...
        try {
            Data data = new Data(Indicador_Data_Tabular_Activity.this);
            data.open();
    ...
    public void descargarGrafico(String titulo){
        ...
        try {
            ...
            LinearLayout mViewToImage = (LinearLayout) findViewById(R.id.ly_tabular);
            if(mViewToImage.getWidth()>0 && mViewToImage.getWidth()>0) {
                ...
                outputStream.flush();
                outputStream.close();
                Toast.makeText(Indicador_Data_Tabular_Activity.this, "Imagen Descargada Exitosamente.", Toast.LENGTH_SHORT).show();
            }
            else {Toast.makeText(Indicador_Data_Tabular_Activity.this, "No Presenta Grafico", Toast.LENGTH_SHORT).show();}
    ...
    public void descargarExcel(String id,String titulo){
        sqliteToExcel.exportAllNTables(""+titulo+".xls",id,titulo, new SQLiteToExcel.ExportListener() {
            ...
            public void onCompleted(String filePath) {
                Toast.makeText(Indicador_Data_Tabular_Activity.this,"Excel Descargado Exitosamente",Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onError(Exception e) {
                Toast.makeText(Indicador_Data_Tabular_Activity.this,"Error:"+e.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
    }
