...
public class Indicador_Data_M3_M2_Activity extends AppCompatActivity {
    int id;
    TextView txt_titulo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_m3_m2);
        ...
        chart = findViewById(R.id.chart_m3_m2_1);
        ...
        chart2 = findViewById(R.id.chart_m3_m2_2);
...
//            }
    ...
    {   ArrayList<String> datos = new ArrayList<>();
        ...
        try {
            Data data = new Data(Indicador_Data_M3_M2_Activity.this);
            data.open();
